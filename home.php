    ...
    ?>
        <div class="col-sm-3">
            <div class="thumbnail">
                ...
                <a href="index.php?halaman=artikel&id=<?php echo $data['id_artikel'];?>"><img src="admin/artikel/gambar/<?php echo $data['gambar'];?>" width="100%" height="250px" alt="Cinque Terre"></a>
