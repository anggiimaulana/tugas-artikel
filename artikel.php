...
?>
<!-- <style>
        /* Menargetkan div dengan class 'row' pertama */
        .row:first-of-type {
            overflow-y: scroll; /* Add this line to enable vertical scrolling if needed */
        }
        /* Hide scrollbar for Chrome, Safari, and Opera */
        .row:first-of-type::-webkit-scrollbar {
            width: 0px;
...
<div class="row">
    <div class="col-sm-8">
        <div class="thumbnail">
            ...
            <img src="admin/artikel/gambar/<?php echo $data['gambar'];?>" width="100%" height="400px" alt="Foto artikel">
            <div class="caption mt-4">
                    <?php
                        echo nl2br(htmlspecialchars($data["isi_artikel"], ENT_QUOTES, "ISO-8859-1"));
                    ?>
                <hr>
            </div>
            <?php
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                <img src="gambar/user.png" width="100%" alt="user">
                            </div>
                            <div class="col-sm-11">
    ...
    <div class="col-sm-4">
    <h3 class="mb-3">Topik lainnya</h3>
        <div class="row">
            <?php
                include 'config/database.php';
