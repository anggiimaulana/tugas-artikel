...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="card-columns">
            ...
            $no++;
            ?>
            <div class="card bg-basic" style="width: 17.5rem;">
            <a href="index.php?halaman=artikel&kategori=<?php echo $data['id_kategori'];?>"><img class="card-img-top" src="artikel/gambar_kategori/<?php echo $data['gambar_kategori'];?>" width="100%" height="150px" alt="Artikel img"></a>
